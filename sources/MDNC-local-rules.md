...
- **Document:** Rules of Practice and Procedure
- **Effective:** April 3, 2024
- **Civil Rules PDF:** https://www.ncmd.uscourts.gov/sites/ncmd/files/CIV_LR_2024.pdf
- **Criminal Rules PDF:** https://www.ncmd.uscourts.gov/sites/ncmd/files/2024_CRI_LR.pdf (eff. Feb. 5, 2024)
...
| 7.1(b) | Telephone/mail/email + state bar number |
| 7.2 | Brief contents (opening, response, reply) |
| 7.3(a) | Each motion a separate document |
| 7.3(d)(1) | Brief length (computer): 6,250 words support/response; 3,125 words reply |
| 7.3(d)(2) | Brief length (typewriter/hand): 20 / 10 pages |
| 7.3(d)(4) | Related-counsel join; single-brief rule for SJ |
| 7.3(f) | Response — 21 days (30 for SJ; 14 for discovery) |
| 7.3(h) | Reply — 14 days (7 if discovery) |
| 7.3(i) | Suggestion of subsequently decided authority |
| 7.3(j) | Motions not requiring briefs |
| 7.6 | Evidentiary objections raised in response/reply; surreply in 7 days if objection raised in reply |
| 15.1 | Amended pleading — attach proposed |
| 16.1(b) | Rule 26(f) meeting ≥ 14 days before IPTC; report within 10 days |
| 16.2 / 16.3 | Rule 26(f) report forms (joint / separate) |
| 16.4 + 83.9a-g | Mediated settlement conferences |
| 26.1(a) | Case-management tracks — **Standard / Complex / Exceptional** with preset discovery periods, interrogatory/RFA caps, deposition caps |
| 26.2 | Protective orders — 14/7 day briefing |
| 30.1 | Deposition conduct guidelines |
| 37.1(a) | Discovery meet-and-confer certificate |
...
|               | Discovery period | Interrog. / RFA each party | Depositions per side |
|---------------|------------------|-----------------------------|----------------------|
| Standard      | 4 months         | 15                          | 4 (incl. experts)    |
| Complex       | 6 months         | 25                          | 7                    |
| Exceptional   | 9 months         | 30                          | 10                   |

## Notes / pitfalls
- **Certificate of word count** required on every brief (LR 7.3(d)(1)).
- **Top margin is 1¼"** (not 1") and **max 27 lines per page** — unique to MDNC.
